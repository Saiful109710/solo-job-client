...
const JobDetails = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    // valid user permission validate
    // if(user.email===buyer.email) return toast.error('access denied! You are not valid user')

    // if deadline cross

    if (compareAsc(new Date(), new Date(deadline)) === 1)
      return toast.error("deadline Crosses,Bidding forbidden");
